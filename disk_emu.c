 ...
 * start_address is the starting block, nblocks is the number of blocks to write,
 * starting with the starting block, buffer contains the contents to write to the blocks
 *------------------------------------------------------------------*/
